...
cd /usr/local/apache-tomcat-6.0.36/webapps/banese/WEB-INF/classes/
...
do
  ...
  /usr/java/jdk1.7.0_71/bin/java -classpath ../lib/gxclassR.jar:../lib/Una2000.jar:../lib/iText.jar:../lib:.:../lib/gxclassR.jar:../lib/jtds-1.2.jar:../lib/ojdbc14.jar:.: van0402 $caminho/$linha
