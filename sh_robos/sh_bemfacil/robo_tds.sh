...
DIRETORIO_GX=/opt/docker/volumes/bemfacil_7/webapps/bemfacil/WEB-INF/classes/
...
cd $DIRETORIO_GX
/opt/java/jdk1.8.0_291/bin/java -Dprocess="bemfacilrobo" -classpath ../lib/commons-lang-2.4.jar:../lib/gxclassR.jar:../lib/Una2000.jar:../lib/iText.jar:../lib:.:../lib/gxclassR.jar:../lib/jtds-1.2.jar:../lib/ojdbc14.jar:.: van0300
