...
/usr/lib/jvm/java-1.7.0-openjdk-amd64/bin/java -classpath ../lib/gxclassR.jar:../lib/Una2000.jar:../lib/iText.jar:../lib:.:../lib/gxclassR.jar:../lib/jtds-1.2.jar:../lib/ojdbc14.jar:.: van0400
