...
echo "INICIANDO pronto_exportacaojava.sh "

cd /usr/libexec/tomcat7/webapps/pronto/WEB-INF/classes
/opt/jdk1.8.0_101/bin/java  -Dprocess="pronto_exportacaojava" -classpath ../lib/commons-lang-2.4.jar:../lib/gxclassR.jar:../lib/Una2000.jar:../lib/iText.jar:../lib:.:../lib/gxclassR.jar:../lib/jtds-1.2.jar:../lib/ojdbc14.jar:.: apr_exp_est >> /mnt/home1/sistema/logs/pronto_exportacaojava.txt
#/opt/jdk1.8.0_101/bin/java  -Dprocess="pronto_exportacaojava" -classpath ../lib/commons-lang-2.4.jar:../lib/gxclassR.jar:../lib/Una2000.jar:../lib/iText.jar:../lib:.:../lib/gxclassR.jar:../lib/jtds-1.2.jar:../lib/ojdbc14.jar:.: apr_envia_transaction_rc >> /mnt/home1/sistema/logs/pronto_exportacaojava.txt
