...
do
  ...
  /opt/java/jdk1.8.0_291/bin/java -classpath ../lib/gxclassR.jar:../lib/Una2000.jar:../lib/iText.jar:../lib:.:../lib/gxclassR.jar:../lib/jtds-1.2.jar:../lib/ojdbc14.jar:.: van0402 $caminho/$linha
