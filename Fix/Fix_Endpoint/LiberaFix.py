...
NaoIncluir.append(os.path.join(diretorioApp, "WEB-INF", "classes", "com", "mobbuyendpointdev", "log4j2.xml"))
NaoIncluir.append(os.path.join(diretorioApp, "WEB-INF", "classes", "com", "mobbuyendpointdev", "client.cfg"))
NaoIncluir.append(os.path.join(diretorioApp, "WEB-INF", "classes", "com", "mobbuyendpointdev", "GXcfg.class"))
NaoIncluir.append(os.path.join(diretorioApp, "WEB-INF", "classes", "com", "mobbuyendpointdev", "GXApplication.class"))
