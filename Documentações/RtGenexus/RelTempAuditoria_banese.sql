...
/****** Object:  StoredProcedure [dbo].[RELTEMPAUDITORIA]    Script Date: 11/11/2022 11:46:39 ******/
SET ANSI_NULLS ON
GO
...
/*ANALITICO VALOR CANCELADO DE AJUSTE- INICIO*/
INSERT INTO RtAjuste (RtAjusteEstCod, RtAjusteNsu, RtAjusteAutCod, RtAjusteDataTrn, RtAjusteProduto,
RtAjusteBandeira, RtAjusteTrnCod, RtAjusteValorTrn, RtAjusteValorLIQEST, 
RtAjusteValor, RtAjusteDataInc, RtAjusteGuid)
SELECT @ESTCOD, A.MovTrnNsu, A.MovTrnAutCodStr, A.MovTrnDta, 
A.MovTrnTipPrd, A.MovTrnBan, A.MovTrnCod, A.MovTrnVlr, A.MovTrnVlrLiqEst, B.VALORCANCELADO, @DATAINC, @RELGUID
FROM MovTrn01 A
INNER JOIN
...
AND A.MovTrnAutCodStr = B.VlpAutCodStr
AND A.MOVTRNCOD = 'CV';
/*ANALITICO VALOR CANCELADO DE AJUSTE - FIM*/
...
RtAnaliticoValorPagoBNF, RtAnaliticoValorConc, RtAnaliticoGuid, RtAnaliticoUsr, RtAnaliticoDataInc)
SELECT 
...
B.VALORCESSAOORI, B.CUSTOANT, B.VALORCESSAOBNF, B.PAGOBNF, B.VALORCONCILIADO, @RELGUID, @UsrId, @DATAINC
